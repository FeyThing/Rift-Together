...
local function groundfx_fn()
    ...
    --inst.components.timer:StartTimer("trap_lifetime", TUNING.RT_PAWN_PULSE_TRAP_LT)
    return inst
end

return Prefab("rt_pawn_trap", groundfx_fn, assets)
...
--return MakeSinkhole("daywalker_sinkhole", TUNING.DAYWALKER_SLAM_SINKHOLERADIUS, 1, true, true)]]