...
local function SetSize(inst, sz, mod)
    ...
    if sz == "medium" then
        inst.loot =
        {
            { prefab = "nanotech", chance = TUNING.METEOR_CHANCE_INVITEM_OFTEN * mod },
            { prefab = "nanotech", chance = TUNING.METEOR_CHANCE_INVITEM_RARE * mod },
            { prefab = "raritaniumore", chance = TUNING.METEOR_CHANCE_INVITEM_ALWAYS * mod },
            { prefab = "raritaniumore", chance = TUNING.METEOR_CHANCE_INVITEM_VERYRARE * mod },
            { prefab = "scrapmetal", chance = TUNING.METEOR_CHANCE_INVITEM_SOMETIMES * mod },
        }
    elseif sz == "large" then
        ...
        elseif rand <= TUNING.METEOR_CHANCE_BOULDERMOON * mod then
...
return Prefab("raritaniummeteor", fn, assets, prefabs)
