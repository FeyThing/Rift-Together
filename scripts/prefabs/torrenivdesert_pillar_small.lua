...
---Eventually these should spawn swarmers randomly.
...
local function fn()
    ...
    inst.AnimState:SetBank("pillar_torrenivdesert_small")
    inst.AnimState:SetBuild("pillar_torrenivdesert_small")
...
return Prefab("torrenivdesert_pillar_small", fn, assets)
