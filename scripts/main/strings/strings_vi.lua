...
general_scripts.RATCHET1 = {
	cast = {"ratchet"},
	lines = {
		{roles = {"ratchet"}, 	duration = 2.5, line = STRINGS.STAGEACTOR.RATCHET1[1], 		anim = "emote_waving"},
		{roles = {"ratchet"}, 	duration = 2, 	line = STRINGS.STAGEACTOR.RATCHET1[2]},
		{actionfn = fn.callbirds, 	duration = 1.5},
		{roles = {"ratchet"}, 	duration = 3, 	line = STRINGS.STAGEACTOR.RATCHET1[3]}, 	
		...
		{roles = {"ratchet"}, 	duration = 3, 	line = STRINGS.STAGEACTOR.RATCHET1[11]},
		{roles = {"ratchet"}, 	duration = 3, 	line = STRINGS.STAGEACTOR.RATCHET1[12]},
		{roles = {"ratchet"}, 	duration = 3, 	line = STRINGS.STAGEACTOR.RATCHET1[13]},
		{roles = {"ratchet"}, 	duration = 2, 	line = STRINGS.STAGEACTOR.RATCHET1[14],    anim= "spooked"},
		{roles = {"ratchet"}, 	duration = 3, 	line = STRINGS.STAGEACTOR.RATCHET1[15]},
		{roles = {"ratchet"}, 	duration = 3, 	line = STRINGS.STAGEACTOR.RATCHET1[16]},
		...
		{roles = {"ratchet"}, 	duration = 4, 	line = STRINGS.STAGEACTOR.RATCHET1[19],    anim= "emote_strikepose"},
		{roles = {"ratchet"}, 	duration = 3, 	line = STRINGS.STAGEACTOR.RATCHET1[20],	anim= "emote_shrug"},
		{roles = {"BIRD2"}, 	duration = 2, 	line = STRINGS.STAGEACTOR.RATCHET1[21], 	sgparam = "disappointed"},
		
		{roles = {"ratchet"}, 	duration = 3, 	line = STRINGS.STAGEACTOR.RATCHET1[22],	anim = "emote_laugh"},
		{roles = {"ratchet"}, 	duration = 1.8, line = STRINGS.STAGEACTOR.RATCHET1[23]}, 	
...
local strings = {
	...
	STAGEACTOR = {
        ...
        "B...but I sure can try! Uh lemme see. Think Ratchet, think.",
		...
		-- RATCHET
        "Anyway, the lombax came up with a objectively great idea!",
        "He named the invention stunderwear!",
        "Who knew it'll sell surprisingly well.",
				
	    -- BIRDS
        "...",

		-- RATCHET
        "I...I'm guessing that wasn't a particular great story afterall.",
        "Hehe, whoops I think...I may have left the stove on. Gotta split!",		
		}
