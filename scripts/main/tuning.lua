...
--- Character moved for later release
	...
	--- Creatures
	RT_PAWN_HEALTH = 200,
	RT_PAWN_WALK_SPEED = 4,
	RT_PAWN_DAMAGE = 10,
	RT_PAWN_PULSE_RANGE = 4,
	RT_PAWN_PULSE_TICK_TIME = 1,
	RT_PAWN_SEE_CHESS_RANGE = 20,
	RT_PAWN_MAX_TARGET_SHARES = 5,
	RT_PAWN_BUFF_DURATION = 5,
	RT_PAWN_BUFF_KNIGHT_ATTACK_MULT = 1.5,
	RT_PAWN_BUFF_BISHOP_ATTACK_PERIOD = TUNING.BISHOP_ATTACK_PERIOD / 2,
	RT_PAWN_BUFF_ROOK_SPEED_MULT = 2,
