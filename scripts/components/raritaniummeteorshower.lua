...
local RaritaniumMeteorShower = Class(function(self,inst)
    self.inst = inst
...
function RaritaniumMeteorShower:IsShowering()
    return self.dt ~= nil
end

function RaritaniumMeteorShower:IsCoolingDown()
    return self.task ~= nil and self.dt == nil
end

function RaritaniumMeteorShower:SpawnMeteor(mod)
    ...
    if fan_offset ~= nil then
        local met = SpawnPrefab("raritaniummeteor")
...
function RaritaniumMeteorShower:StartShower(level)
    self:StopShower()
...
function RaritaniumMeteorShower:StopShower()
...
function RaritaniumMeteorShower:StartCooldown()
    self:StopShower()
...
function RaritaniumMeteorShower:OnSave()
    local level_params = SHOWER_LEVELS[self.level]
...
function RaritaniumMeteorShower:OnLoad(data)
...
function RaritaniumMeteorShower:GetDebugString()
...
RaritaniumMeteorShower.OnRemoveFromEntity = RaritaniumMeteorShower.StopShower

return RaritaniumMeteorShower
